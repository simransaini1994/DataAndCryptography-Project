...
public class AES {
	...
	static final byte[] S = { 
		   ...
		   -48, -17, -86, -5, 67, 77, 51, -123, 69, -7, 2, 127, 80, 60, -97, -88,  //this is 6th row of s-box
			...
			-73, -3, -109, 38, 54, 63, -9, -52, 52, -91, -27, -15, 113, -40, 49, 21,// this is 2nd row of s-box
	...
	public static void main(String[] args) {
		...
		// AES test triple (128-bit key test value from FIPS-197)
		 ...
		 self_test("1a0c24f2875495bcb7080e43920f567b",
				  "0000000000000000000000000000abcb", lev);      // For modified S-box
			
		 /* self_test("000102030405060708090a0b0c0d0e0f",     // For original S-box
		  "00112233445566778899aabbccddeeff", lev); */
